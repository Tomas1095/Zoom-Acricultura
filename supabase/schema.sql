...
-- ─────────────────────────────────────────────────────────────────────────
-- Subgrupo personal dentro de "Mi equipo" (ver migración 0013)
-- ─────────────────────────────────────────────────────────────────────────

-- A pedido del usuario: con socio Gerente y Socio Fundador viendo la MISMA
-- lista completa de personal, cada uno quería poder marcar cuáles son "los
-- suyos" (con quiénes trabaja de verdad) para no tener que scrollear entre
-- la gente de su socio al buscar a alguien. Es una marca PERSONAL de quien
-- la pone — cada Socio arma su propio subgrupo, sin pisar el del otro ni
-- cambiar lo que ve nadie más.
